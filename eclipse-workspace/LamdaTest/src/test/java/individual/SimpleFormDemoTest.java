...
public class SimpleFormDemoTest {
	...
	public void setUp() throws Exception {
		...
		ltOptions.put("project", "SimpleFormDemoTest");
		ltOptions.put("build", "SimpleFormDemoTest");
		...
		// Initialize the RemoteWebDriver with the URL of the Selenium Grid (LambdaTest in this case)
	...
	public void simpleForm() throws Exception {
		...
		if (driver == null) {
			throw new NullPointerException("Driver is not initialized. Please check the setup.");
		}
